...
public class AuthController {
    ...
    @PostMapping("/refresh")
    public ResponseEntity<?> refresh(@RequestBody @Valid RefreshParams refreshParams, HttpServletResponse response) {
        LoginResultDTO result = authFacade.refresh(refreshParams);
