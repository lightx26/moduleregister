package com.pet.moduleregister.adapters.out.persistence.authToken.mappers;

import com.pet.moduleregister.adapters.out.persistence.authToken.AuthTokenEntity;
import com.pet.moduleregister.adapters.out.persistence.shared.mapper.EntityMapper;
...
public class AuthTokenEntityMapper implements EntityMapper<AuthTokenDTO, AuthTokenEntity> {
    ...
    public AuthTokenEntity toEntity(AuthTokenDTO dto) {
        ...
        return AuthTokenEntity.builder()
                .authTokenId(dto.getAuthTokenId())
