package com.pet.moduleregister.infrastructure.adapters.auth.out.persistence.authToken;

import com.pet.moduleregister.infrastructure.adapters.auth.out.persistence.authToken.mappers.AuthTokenDomainMapper;
import com.pet.moduleregister.infrastructure.adapters.auth.out.persistence.authToken.mappers.AuthTokenEntityMapper;
...
public class AuthTokenRepositoryAdapter implements AuthTokenRepositoryPort {
    ...
    public void update(String authTokenId, String refreshToken, Instant updatedAt) {
        authTokenJpaRepository.updateRefreshToken(Long.parseLong(authTokenId), refreshToken, updatedAt);
    }
